...
def add_args(parser):
    ...
    group.add_argument('--prior', type=str, default='vampprior', metavar='P',
                        help='prior: standard, vampprior')
    group.add_argument('--number-components', type=int, default=500, metavar='NC',
...
def main(args):
    ...
    model, lattice = VAEexemplar.load(cfg, args.weights, device=device)
    model.eval()
