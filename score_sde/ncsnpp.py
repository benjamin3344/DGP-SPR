...
class NCSNpp(nn.Module):
  ...
  def __init__(self, args, num_input_channels, Dimg):
    super().__init__()
    ...
    ch_mult = (1, 1)[:self.num_scales]
    self.num_res_blocks = num_res_blocks = args.num_cell_per_scale_dae
    self.attn_resolutions = attn_resolutions = (7, )  # bs_1: (16,) no attention box
    ...
    self.input_size = Dimg // 2 ** (args.num_preprocess_blocks + args.num_latent_scales - 1)
